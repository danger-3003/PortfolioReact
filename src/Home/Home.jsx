...
function Home()
{
    ...
    {
        words:['Aspiring Data Scientist','React Developer'],
        loop:{},
        typeSpeed:120,
        cursor:"True"
    })
        ...
        <>
            <div className='flex items-center justify-center flex-col sm:flex-row py-20 sm:py-28 pl-5 lg:pl-10 pr-5'>
                ...
                <div className="flex items-center sm:items-start flex-col mx-5 sm:ml-5 lg:ml-10 sm:basis-[60%]">
                    ...
                    <p className="mb-5 text-justify sm:text-left text-base">Highly motivated and skilled web developer with proficiency in Python seeking a challenging position to utilize my expertise and contribute to the success of an innovative organization.</p>
                    <div className="w-max">
                        <a href={Resume} className="mx-1 sm:mx-2 px-5 py-0.5 lg:py-1 relative rounded-full border-[2px] border-blue-400 group overflow-hidden bg-transparent text-white font-semibold inline-block">
