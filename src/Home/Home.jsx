...
function Home()
{
    ...
    {
        words:['MERN Stack Developer','React Native Developer'],
        loop:{},
        typeSpeed:120,
        cursor:"True"
    })
        ...
        <>
            ...
            <div ref={sectionHome} className='flex items-center justify-center flex-col sm:flex-row py-20 sm:py-28 pl-5 lg:pl-10 pr-5'>
                ...
                <div data-aos="fade-up" data-aos-duration="1000" className="flex items-center sm:items-start flex-col mx-5 sm:ml-5 lg:ml-10 sm:basis-[60%]">
                    ...
                    <p className="mb-5 text-justify sm:text-left text-base">Highly motivated and skilled React & React Native developer with proficiency in MongoDB, Node JS and Express, seeking a challenging position to utilize my expertise and contribute to the success of an innovative organization.</p>
                    <div className="w-max">
