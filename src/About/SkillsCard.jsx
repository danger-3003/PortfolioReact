function SkillsCard(props)
{
    return(
        <>
            <div className=" bg-[#272727] p-2 sm:px-5 sm:py-3 w-[28vw] sm:w-auto flex items-center justify-start flex-col rounded-md m-2 transition-all duration-200 hover:scale-110">
